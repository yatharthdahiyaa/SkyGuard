...
Single function that constructs the 15-dimensional feature vector used by
...
def build_feature_vector(
    ...
    """
    Construct the canonical 15-element FeatureVector from raw observations,
    spatial consensus, and temporal state.
    ...
    Returns
    -------
    FeatureVector (15 features matching FEATURE_COL_NAMES)
    """
