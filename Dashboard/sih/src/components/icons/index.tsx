...
const createIcon = (name: string, pathD: string | React.ReactNode) => {
  const IconComponent: React.FC<IconProps> = ({
    ...
    return (
      <svg
        ...
        {...rest}
      >
        {typeof pathD === 'string' ? <path d={pathD} /> : pathD}
      </svg>
    );
  };
...
export const AlertOctagon = createIcon('alert-octagon', (
  <>
...
export const BellOff = createIcon('bell-off', (
  <>
...
export const Cpu = createIcon('cpu', (
  <>
    ...
    <path d="M15 2v2m-6-2v2m6 16v2m-6-2v2m11-7h2m-2-6h2m-18 6H2m2-6H2" />
  </>
));
...
export const MessageSquareQuote = createIcon('message-square-quote', (
  <>
...
export const SlidersHorizontal = createIcon('sliders-horizontal', (
  <>
    ...
    <line x1="14" x2="14" y1="1" y2="7" />
    <line x1="8" x2="8" y1="9" y2="15" />
    <line x1="16" x2="16" y1="17" y2="23" />
  </>
));
